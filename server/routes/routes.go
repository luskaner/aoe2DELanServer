...
import (
	"net/http"
	"server/routes/cloudfiles"
	"server/routes/game/account"
	"server/routes/game/achievement"
	"server/routes/game/advertisement"
	Automatch2 "server/routes/game/automatch2"
	"server/routes/game/challenge"
	"server/routes/game/chat"
	"server/routes/game/clan"
	"server/routes/game/cloud"
	"server/routes/game/communityEvent"
	"server/routes/game/invitation"
	"server/routes/game/item"
	"server/routes/game/leaderboard"
	"server/routes/game/login"
	"server/routes/game/news"
