...
* Server:
    ...
    * macOS:
        * **Big Sur (v11) or higher with Apple Silicon - Arm64**: aoe2DELanServer_server_1.3.0_mac_apple-silicon.tar.gz
        * **Catalina (v10.5) or higher with Intel - x86-64**: aoe2DELanServer_server_1.3.0_mac_intel.tar.gz
